...
set(stdout_log "/home/evgeniy/MPI-PI_Monte_Karlo/build/gsl_build/src/gsl_external-stamp/gsl_external-build-out.log")
set(stderr_log "/home/evgeniy/MPI-PI_Monte_Karlo/build/gsl_build/src/gsl_external-stamp/gsl_external-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/evgeniy/MPI-PI_Monte_Karlo/build/gsl_build/src/gsl_external-stamp/gsl_external-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "gsl_external build command succeeded.  See also /home/evgeniy/MPI-PI_Monte_Karlo/build/gsl_build/src/gsl_external-stamp/gsl_external-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
